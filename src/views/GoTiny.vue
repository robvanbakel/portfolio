      ...
      <div class="feature">
        ...
        <div class="feature-text" v-if="lang === 'nl'">
          ...
          <p>
            ...
            funcionaliteit in de API. Met veelzijdigheid in het achterhoofd is deze opgezet om gebruikt te kunnen worden
            in een breed scala aan applicaties.
          </p>
          <p>
        ...
        <div class="feature-text" v-else>
          ...
          <p>
            ...
            easily is the API behind it. Because I wanted to make the functionality accessible to other developers so
            they can implement it in their projects as well, I created the
